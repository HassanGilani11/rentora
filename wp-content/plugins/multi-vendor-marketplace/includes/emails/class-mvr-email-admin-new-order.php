...
if ( ! class_exists( 'MVR_Email_Admin_New_Order', false ) ) {

	/**
	 * New Order.
	 *
	 * New order emails are sent to admin when a vendor received order submitted by a customer.
	 *
	 * @class MVR_Email_Admin_New_Order
	 * @package class
	 * @extends MVR_Abstract_Email
	 */
	class MVR_Email_Admin_New_Order extends MVR_Abstract_Email {
		...
		public function __construct() {
			$this->id             = 'mvr_email_admin_new_order';
			$this->title          = __( 'New Order', 'multi-vendor-marketplace' );
			$this->description    = __( 'New Order emails are sent to Admin when a vendor received order submitted by a customer.', 'multi-vendor-marketplace' );
			$this->template_html  = 'emails/admin-new-order.php';
			$this->template_plain = 'emails/plain/admin-new-order.php';
			$this->subject        = __( '{site_title}: New Order Received for Vendor', 'multi-vendor-marketplace' );
			$this->heading        = __( 'A New Order Received for Vendor', 'multi-vendor-marketplace' );
...
return new MVR_Email_Admin_New_Order();
