...
?>
<div class="wc-backbone-modal mvr-add-vendor-wrapper">
	<div class="wc-backbone-modal-content">
		<section class="wc-backbone-modal-main" role="main">
			<header class="wc-backbone-modal-header">
				<h1><?php esc_html_e( 'Add Vendor', 'multi-vendor-marketplace' ); ?></h1>
			</header>
			<article>
				<p class="mvr-fields">
					<label for="_vendor_selection_type"><?php esc_html_e( 'Add Vendor from:', 'multi-vendor-marketplace' ); ?></label>
					<select class="mvr-vendor-selection-type" name="_vendor_selection_type">
						<?php
						$options = array(
				...
				<p class="mvr-add-vendor-fields mvr-new-user-field">
				...
				<p class="mvr-add-vendor-fields mvr-existing-user-field">
					<label for="_selected_user"><?php esc_html_e( 'Select User:', 'multi-vendor-marketplace' ); ?></label>
					<?php
					mvr_select2_html(
						array(
							'id'           => '_selected_user',
							'class'        => 'mvr-select2-search mvr-selected-user mvr-required-field',
			...
			<footer>                
				<div class="inner">
					<button class="mvr-add-vendor button button-primary" style="display:none;"><?php esc_html_e( 'Add Vendor', 'multi-vendor-marketplace' ); ?></button>
					<a href="<?php echo esc_url( get_admin_url( null, 'edit.php?post_type=mvr_vendor' ) ); ?>" class="mvr-cancel-vendor-adding button"><?php esc_html_e( 'Cancel', 'multi-vendor-marketplace' ); ?></a>
				</div>
			</footer>
		</section>
	</div>
