 ...
 *
 * This template can be overridden by copying it to yourtheme/multi-vendor-marketplace/emails/admin-new-vendor-request.php.
 *
...
<p>
	...
	printf( wp_kses_post( __( 'A new Vendor Application has been submitted on your site %1$s. The Applicant\'s details are as follows,', 'multi-vendor-marketplace' ) ), esc_html( get_bloginfo( 'name', 'display' ) ) );
	?>
</p>
